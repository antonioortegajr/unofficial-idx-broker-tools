...
function isMobileReady($url, $apiKey)
  {
    ...
    switch ($mobile_friendly) {
      case 0:
      $mobile_friendly = '<h3>Not Mobile Friendly</h3> Not mobile friendly.<br>
      <p>
      ...
      <p>
      Visit <a href=https://www.google.com/webmasters/tools/mobile-friendly/?url='.$url.' target="_blank">Google\'s mobile test page</a> for more info on this test.
      </p>';
      break;
      case 1:
